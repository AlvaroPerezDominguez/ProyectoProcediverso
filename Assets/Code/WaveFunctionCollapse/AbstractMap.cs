...
public abstract class AbstractMap
{
	...
	// Variable para contar el número de piezas colocadas
	public int pieceCount = 0;

	// Límite de piezas deseado
	public int PieceLimit = LimiteConstruccion.PieceLimit;
	...
	public void NotifySlotCollapsed(Slot slot)
	{
		...
		pieceCount++;
		Debug.Log("Número de piezas colocadas: " + pieceCount);

		// Verificar si se ha alcanzado el límite deseado
		if (pieceCount >= PieceLimit)
		{
			// Detener la construcción del mapa
			Debug.Log("Se ha alcanzado el límite de piezas. Deteniendo la construcción del mapa.");
			return;
		}
	}
	...
	public void NotifySlotCollapseUndone(Slot slot)
	{
		...
		// Decrementar el contador de piezas
		pieceCount--;
		Debug.Log("Número de piezas colocadas: " + pieceCount);
	}
	...
	public void Undo(int steps) {
		...
		if (this.History.Count == 0) {
			...
			// Reiniciar el contador de piezas colocadas
			pieceCount = 0;
		}
	}
